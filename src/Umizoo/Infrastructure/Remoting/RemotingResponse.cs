...
namespace Umizoo.Infrastructure.Remoting
{
    public class RemotingResponse
    {
        ...
        public RemotingResponse(RemotingRequest request)
        {
        ...
        public RemotingResponse(RemotingRequest request, short responseCode, byte[] responseBody, DateTime responseTime, IDictionary<string, string> responseHeader)
            : this(request.Type, request.Code, request.Sequence, request.CreatedTime, request.Header,
                  responseCode, responseBody, responseTime, responseHeader)
        { }

        public RemotingResponse(short requestType, short requestCode, long requestSequence, DateTime requestTime, IDictionary<string, string> requestHeader, short responseCode, byte[] responseBody, DateTime responseTime, IDictionary<string, string> responseHeader)
        {
        ...
        public override string ToString()
        {
            ...
            var requestTime = RequestTime.ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss.FFFFFFFK");
            var responseTime = ResponseTime.ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss.FFFFFFFK");
